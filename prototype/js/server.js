...
app.post("/upload-video", (req, res) => {
  videoUpload(req, res, async function (err) {
    ...
    try {
      ...
      // Get S3 URL
      const s3Url = `https://s3.${process.env.AWS_REGION}.amazonaws.com/${process.env.S3_BUCKET_NAME}/Videos/${filename}`;
...
app.post("/upload-audio", (req, res) => {
  audioUpload(req, res, async function (err) {
    ...
    try {
      ...
      // Get S3 URL
      const s3Url = `https://s3.${process.env.AWS_REGION}.amazonaws.com/${process.env.S3_BUCKET_NAME}/Audio/${filename}`;
